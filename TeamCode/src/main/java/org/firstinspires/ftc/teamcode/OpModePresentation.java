...
public class OpModePresentation extends CommandOpMode {
    ...
    // delays
    public static double delayTransfer = 300, delayRelease = 1200, delayCloseTransfer = 220, delayGoToTransfer = 500;
    ...
    void intakeStateMachine()
    {
        switch (intakeState) {
            case RETRACT:
                ...
                if (betterGamepad1.rightBumperOnce() && !robot.has2Pixels()) {
                    intakeState = IntakeState.INTAKE;
                } else if (gamepad1.right_trigger != 0 && !robot.has2Pixels() && !heldExtension) {
