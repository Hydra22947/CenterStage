...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.00293090823;
        public double lateralInPerTick = 0.0018971459635921768;
        public double trackWidthTicks = 4201.409368515111;
        ...
        public double axialGain = 8.9;
        public double lateralGain = 8;
        public double headingGain = 10.8; // shared with turn
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            if ((t >= timeTrajectory.duration && error.position.norm() < 2
                    && robotVelRobot.linearVel.norm() < 0.5 && error.heading.log() < 1)
                    || t >= timeTrajectory.duration + 1.5) {
