...
import java.util.List;
    ...
    public final class MecanumDrive {
        ...
        public static class Params {
            ...
            public double axialGain = 3.15;
            public double lateralGain = 1.7;
            public double headingGain = 1.7; // shared with turn

            public double axialVelGain = 3.25;
            public double lateralVelGain = 0.07;
        ...
        public MecanumDrive(Pose2d pose, RobotHardware robot) {
            this.pose = pose;

            LynxFirmware.throwIfModulesAreOutdated(robot.hardwareMap);
            ...
            localizer = new ThreeDeadWheelLocalizer(robot.hardwareMap, PARAMS.inPerTick);
