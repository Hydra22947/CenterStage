...
public class AutoConstants {
    ...
    public static double intakePixelVectorX = -40, intakePixelVectorY = -9.3;
    public static double ROBOT_ERROR_INTAKE_Y = -1.5;
    public static double ROBOT_ERROR_INTAKE_X = -1.755;
    //WAIT TIME
