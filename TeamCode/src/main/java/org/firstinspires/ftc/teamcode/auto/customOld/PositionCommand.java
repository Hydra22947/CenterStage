...
public class PositionCommand extends CommandBase {
    ...
    public PositionCommand(Pose targetPose, SampleMecanumDrive drive) {
    ...
    Pose getCurrentPos()
    {
        ...
        return new Pose(drive.getPoseEstimate().getX(), drive.getPoseEstimate().getY(), drive.getPoseEstimate().getHeading());
    }
}
