...
public class PropPipelineRedLeftBlueRight implements VisionProcessor, CameraStreamSource {
    private static final boolean DEBUG = true;

    // TODO: change x , y of cubes
    public static int redCenterX = (int) (215);
    public static int redCenterY = (int) (450);
    public static int redRightX = (int) (965);
    public static int redRightY = (int) (275);
    ...
    public PropPipelineRedLeftBlueRight(Alliance alliance) {
        this(null, alliance);
    }

    public PropPipelineRedLeftBlueRight(Telemetry telemetry, Alliance alliance) {
