...
public class Claw implements Subsystem
{
    ...
    // LOOK FORM INTAKE
    public  static double openLeft = .22, closeLeft = .52;
    public static double openRight = .44, closeRight = .65;
    public static double intermediateLeft = .35, intermediateRight = .5;
