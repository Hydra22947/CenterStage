...
@Config
@Autonomous(name = "2+2 - Auto BlueLeftLeft+ Cycle")
public class BlueLeftLeftPreloadAndCycle extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Action goPlaceWhiteLEFT = robot.drive.actionBuilder(new Pose2d(-41.8, 42.8 ,Math.toRadians(10)))
