...
public class AutoRedRightRight {
    ...
    public SequentialAction redRightRight;

    public AutoRedRightRight(Telemetry telemetry, HardwareMap hardwareMap) {
        ...
        redRightRight = new SequentialAction(
                placePurplePixel,
                placePreloadOnBoard,
                intake54,
                deposit54
