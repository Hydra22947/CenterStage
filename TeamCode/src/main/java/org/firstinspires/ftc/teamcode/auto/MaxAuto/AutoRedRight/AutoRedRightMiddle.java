...
public class AutoRedRightMiddle{
    ...
    public SequentialAction redRightMiddle;

    public AutoRedRightMiddle(Telemetry telemetry, HardwareMap hardwareMap) {
        ...
        redRightMiddle = new SequentialAction(
                placePurplePixel,
                placePreloadOnBoard,
                intake54,
                deposit54
