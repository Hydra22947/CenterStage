...
public class PoseStorage {
    ...
    public static final double stageDoorMidPoseX = 30, stageDoorMidPoseY = -21.5, stageDoorMidPoseHeading = 90;
    public static final double stageDoorEndPoseX = 30, stageDoorEndPoseY = -21.5;
